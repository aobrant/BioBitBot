...
inline_btn_02 = InlineKeyboardButton(text='View BioBits (under construction)', callback_data='btn_view_bits')
...
inline_btn_14 = InlineKeyboardButton(text='Daily water consumption (add 1 liter)', callback_data='btn_water')
...
inline_kb_beats.row(inline_btn_16)
